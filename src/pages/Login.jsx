...
function Login() {
  ...
  left: 30px;        /* thoda right shift */
  background-color: #ffc007; /* professional yellow */
  border: none;
...
.back-btn:hover {
  background-color: #e6ac06; /* hover dark yellow */
  transform: translateY(-2px);
}

.back-icon {
  color: #fff;       /* arrow white inside yellow button */
  font-size: 24px;   /* bada arrow */
}
